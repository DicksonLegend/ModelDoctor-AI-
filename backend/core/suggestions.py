...
async def enhance_with_ai(diagnosis: list, suggestions: list, use_ai: bool = True) -> list:
    """
...
def _build_plain_language_fallback(
    ...
    class_note = ""
    if task_type != "regression" and class_distribution:
        try:
    ...
    summary.extend([
        ...
        (
            ...
            if task_type != "regression"
            else "After retraining, compare health score with both R2 and RMSE together, not a single metric alone."
        ),
